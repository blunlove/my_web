<template>
  <div class="al-input">
    <div class="al-input-content" v-if="type === 'service'">
      <service-input
        ref="input"
        :value="value"
    ...
    <div class="al-input-content" v-else :style="{width: width + 'px'}">
      <el-input
        ref="input"
        :value="value"
        v-bind="{
...
<script>
  import placeholder from 'djweb/src/mixins/placeholder';
