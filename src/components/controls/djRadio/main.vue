<template>
  <el-radio-group
    ...
    <el-radio
      ...
      :label="(item[keyMap_.value] === 0 || item[keyMap_.value]) ? item[keyMap_.value] : item[keyMap_.label]"
      :key="(item[keyMap_.value] === 0 || item[keyMap_.value]) ? item[keyMap_.value] : item[keyMap_.label]">{{item[keyMap_.label]}}</el-radio>
  </el-radio-group>
</template>
